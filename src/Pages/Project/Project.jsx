...
import swadeshiImg from "../img/swadesi.png";
import culturalImg from "../img/festival.png";
import healthImg from "../img/medical.jpg";
...
const impactStats = [
  { value: "11", label: "Major Programs", icon: "📋", color: "blue" },
