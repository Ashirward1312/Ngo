...
function InfoItem({ icon, title, children }) {
  return (
    <div className="group flex items-start gap-4 rounded-2xl p-4 transition-all duration-300 hover:bg-orange-50/60">
...
export default function Contact() {
  const WHATSAPP_NUMBER = "919329445769"; // ✅ +91 93294-45769
  ...
  const subjectLabel = (val) => {
    ...
    return map[val] || val || "General Inquiry";
  };
  ...
  // ✅ CHANGE: Submit -> Direct WhatsApp Open (with message)
  const handleSubmit = (e) => {
    ...
    // optional: show success state on page too
    setTimeout(() => {
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .contact-success-pop { animation: contact-success-pop 0.5s cubic-bezier(0.16, 1, 0.3, 1) forwards; }

        @keyframes contact-shimmer {
          0% { background-position: -200% center; }
          100% { background-position: 200% center; }
        }
        .contact-shimmer-btn { background-size: 200% 100%; animation: contact-shimmer 3s ease-in-out infinite; }
        ...
        .contact-gradient-animate { background-size: 200% 200%; animation: contact-gradient-shift 4s ease infinite; }
      ...
      <section
        id="contact"
        className="relative overflow-hidden bg-gradient-to-b from-gray-50 via-white to-orange-50/30 py-20 md:py-28"
      >
        {/* Background Elements */}
                ...
                <div className="contact-glass contact-card-hover rounded-3xl border border-white/60 p-6 shadow-lg ring-1 ring-gray-100/50 md:p-7">
                  ...
                  <div className="space-y-1">
                    ...
                    <InfoItem icon={<EmailIcon />} title="Email">
                      <a
                        href="mailto:sansthansambhav9@gmail.com"
                        className="font-semibold text-gray-800 transition-colors hover:text-orange-600"
                      >
              ...
              <FadeIn delay={160}>
                <div className="contact-card-hover overflow-hidden rounded-3xl border border-white/60 bg-white shadow-lg ring-1 ring-gray-100/50">
                  <div className="flex items-center gap-3 border-b border-gray-100 px-5 py-3.5">
                    ...
                    <span className="text-sm font-bold text-gray-900">Find Us on Map</span>
                  </div>
            ...
            <FadeIn delay={120} className="lg:col-span-3">
              <div className="contact-glass contact-card-hover rounded-3xl border border-white/60 p-6 shadow-lg ring-1 ring-gray-100/50 md:p-9">
                ...
                <p className="mb-7 pl-[52px] text-sm text-gray-500">
                  When you submit, WhatsApp will open directly on{" "}
                  <span className="font-semibold text-gray-700">+91 93294-45769</span>.
                </p>
                ...
                {isSubmitted ? (
                  <div className="contact-success-pop flex flex-col items-center justify-center rounded-2xl bg-gradient-to-br from-green-50 to-emerald-50 py-14 text-center">
                    ...
                    <h4 className="text-2xl font-black text-gray-900">WhatsApp Opened</h4>
                    <p className="mt-2 max-w-xs text-sm leading-relaxed text-gray-600">
                      Your message is ready in WhatsApp. Just press send.
                    </p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <p className="text-center text-xs text-gray-400">
                      Your message will open in WhatsApp on +91 93294-45769.
                    </p>
                  </form>
                )}
              </div>
